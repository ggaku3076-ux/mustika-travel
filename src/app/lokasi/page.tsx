    ...
    >
      <div className="mx-auto max-w-7xl px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start mt-8">
            ...
            <div>
              ...
              <div className="flex flex-col gap-5">
                <div className="flex items-start gap-4">
                  <div className="h-10 w-10 rounded-lg bg-brand-blue-bg border border-brand-blue/20 flex items-center justify-center text-brand-blue shrink-0">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-brand-dark/70 mt-1">
                      <a href="tel:+628123456789" className="hover:text-brand-blue transition-colors">
                        0812-3456-789
                      </a>
                    </p>
                  </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-brand-dark/70 mt-1">
                      <a href="mailto:info@mustikatravel.com" className="hover:text-brand-blue transition-colors">
          ...
          <div className="flex flex-col gap-6 p-6 sm:p-8 bg-brand-blue-bg border border-brand-blue/15 rounded-2xl">
            <h2 className="text-xl font-bold text-brand-dark text-left font-nunito">Peta Lokasi</h2>
            
            {/* Visual map wireframe */}
            <div className="relative aspect-[16/10] w-full rounded-xl border border-brand-blue/30 bg-white p-4 flex flex-col justify-between overflow-hidden">
              <div className="absolute inset-0 grid grid-cols-6 grid-rows-4 pointer-events-none opacity-10">
                <div className="border-r border-b border-brand-blue/20" />
                <div className="border-r border-b border-brand-blue/20" />
                <div className="border-r border-b border-brand-blue/20" />
                <div className="border-r border-b border-brand-blue/20" />
                <div className="border-r border-b border-brand-blue/20" />
                <div className="border-b border-brand-blue/20" />
              </div>

              {/* Pin */}
              <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center gap-1 z-10">
                <div className="h-10 w-10 rounded-full bg-brand-blue flex items-center justify-center text-white shadow-lg animate-bounce">
            ...
            <div className="flex flex-col gap-4 text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <a
                  ...
                  className="flex-1 inline-flex items-center justify-center gap-2 rounded-xl bg-brand-blue py-3 px-4 text-xs font-bold text-white hover:bg-brand-blue-light transition-all shadow-sm"
                >
